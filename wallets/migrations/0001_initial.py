    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basket_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cartitems', to='wallets.basket')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('basket_item_objects', models.ManyToManyField(to='wallets.basketitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('brand_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wallets.brand')),
                ('category_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wallets.category')),
                ('size_object', models.ManyToManyField(to='wallets.size')),
                ('tag_object', models.ManyToManyField(to='wallets.tag')),
            ],
        ),
        migrations.AddField(
            model_name='basketitem',
            name='product_object',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wallets.product'),
        ),
        migrations.AddField(
            model_name='basketitem',
            name='size_object',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wallets.size'),
        ),
    ]
